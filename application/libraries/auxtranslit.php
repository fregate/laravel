...
This code is adaptation from drupal module
 ...
 *   Transliterated text.
 */
protected function _transliteration_process($string, $unknown = '?') {
 ...
 */
protected function _transliteration_replace($ord, $unknown = '?') {
  static $map = array();
 ...
 */
public function translit_title($filename) {
  if (is_array($filename)) {
    foreach ($filename as $key => $value) {
      $filename[$key] = $this->translit_title($value);
    }
    return $filename;
  }
